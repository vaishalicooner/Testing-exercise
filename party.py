...
def is_mel(name, email):
    ...
    True
    >>> is_mel('Mel Melitpolski','hello@ubermelon.com')
    True
...
def most_and_least_common_type(treats):
    ...
    >>> treats = [{'type':'dessert'}, {'type':'drink'},{'type':'drink'},{'type':'dessert'},{'type':'drink'}]
    >>> most_and_least_common_type(treats)
    ('drink', 'dessert')

    >>> treats = [{'type':'dessert'}, {'type':'drink'},{'type':'drink'},{'type':'dessert'}]
    >>> most_and_least_common_type(treats)
    ('dessert', 'dessert')

    >>> treats = [{'type':'dessert'}, {'type':'drink'},{'type':'drink'},{'type':'dessert'},{'type':'drink'},{'type':'appetizer'}]
    >>> most_and_least_common_type(treats)
    ('drink', 'appetizer')
